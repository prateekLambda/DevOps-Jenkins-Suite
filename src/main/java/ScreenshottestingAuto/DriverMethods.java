...
public class DriverMethods {
    ...
    public void ShareBox(RemoteWebDriver driver) {
        try {
            System.out.println("sharable method started");
            ...
            driver.findElement(By.cssSelector("#lambda_email_ids_\\@\\#\\$")).click();

            driver.findElement(By.cssSelector("#lambda_email_ids_\\@\\#\\$")).sendKeys("prateek.delguy@gmail.com");
            driver.findElement(By.cssSelector("#add_note_\\@\\#\\$")).sendKeys("FInd the bug");
